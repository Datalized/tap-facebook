...
class AdCreative(Stream):
    ...
    @retry_pattern(backoff.expo, (FacebookRequestError, AttributeError), max_tries=5, factor=600)
...
class AdsInsights(Stream):
    ...
    @retry_pattern(backoff.expo, (FacebookRequestError, InsightsJobTimeout, FacebookBadObjectError, TypeError, AttributeError), max_tries=5, factor=600)
